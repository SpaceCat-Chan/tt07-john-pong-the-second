    ...
    def elaborate(self, platform):
        ...
        with m.If(prev_vsync & ~self.vga.o_vsync): # we just entered vsync, do all logic now
            ...
            with m.Else():
                ...
                with m.If(pope_location[10:20] >= 480 - 38):
                    m.d.pix += pope_v_velocity.eq(Mux(pope_v_velocity < 0, pope_v_velocity, -pope_v_velocity))
                ...
                with m.If((pope_location[0:10] >= 640 - 50 - 34) & ((pope_location[10:20] > enemy_paddle_location - 38) & (pope_location[10:20] <= enemy_paddle_location + 150)) & (self.i_player_two_active == 0)):

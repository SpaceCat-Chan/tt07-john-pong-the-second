...
class BoilerplateSubtarget(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.vga = self.vga = Top(16, 16)
...
class BoilerplateAppletTestCase2(GlasgowAppletTestCase, applet=RayApplet):
    @synthesis_test
    def test_build(self):
        self.assertBuilds()
